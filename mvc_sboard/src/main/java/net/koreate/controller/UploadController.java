...
public class UploadController {
	...
	@ResponseBody
	public ResponseEntity<String> deleteAllFilesPOST(@RequestParam("files[]") String[] files) throws Exception {
		logger.info("DeleteAllFilesPOST Called!!!");
		
		if(files == null || files.length == 0) return new ResponseEntity<String>("deleted", HttpStatus.OK);
